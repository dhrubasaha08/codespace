...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        qur = "create table if not exists product (id int primary key auto_increment, product_name varchar(255), price int, gst int, total int);";
        stmt.executeUpdate(qur);
        ...
        switch (choice) {
            case 1:
                ...
                qur = "insert into product (product_name, price, gst, total) values ('" + product_name + "', " + price + ", " + gst + ", " + total + ");";
                stmt.executeUpdate(qur);
            ...
            case 3:
                ...
                qur = "update product set product_name = '" + product_name + "', price = " + price + ", gst = " + gst + ", total = " + total + " where id = " + id + ";";
                stmt.executeUpdate(qur);
